...
async function buildSeedData() {
  ...
  return {
    ...
    hospitals: [
      ...
      { id: "h2", name: "Apollo Emergency Center", lat: 28.5672, lng: 77.21, icuBeds: 8, emergencyBeds: 16, totalBeds: 150, occupancy: 65, capacity: 14, burnUnit: true },
    ...
    ambulances: [
      { id: "a1", vehicleNo: "DL-01-AB-1234", driverName: "Suresh Kumar", lat: 28.62, lng: 77.215, status: AMBULANCE_STATUS.FREE, hospitalId: "h1" },
      { id: "a2", vehicleNo: "DL-02-CD-5678", driverName: "Rajesh Singh", lat: 28.58, lng: 77.2, status: AMBULANCE_STATUS.FREE, hospitalId: "h2" },
      { id: "a3", vehicleNo: "DL-03-EF-9012", driverName: "Amit Verma", lat: 28.6, lng: 77.23, status: AMBULANCE_STATUS.BUSY, hospitalId: "h1" },
      { id: "a4", vehicleNo: "DL-04-GH-3456", driverName: "Pradeep Yadav", lat: 28.635, lng: 77.205, status: AMBULANCE_STATUS.FREE, hospitalId: "h3" },
